...
// images
import wave from "src/assets/images/authentication/wave.png";
import unlock from "src/assets/images/authentication/unlock.svg";
import avatar from "src/assets/images/authentication/avatar.svg";
...
const Login = () => {
  ...
  // if authenticated
  if (Object.keys(users).length  && success) {
      navigate("/dashboard");  
  }
  // return
  return (
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="font-display flex flex-col justify-center items-center xl:w-1/2 mx-1 xl:mx-1">
              ...
              <div className="mb-2 w-full">
                ...
                />
                {errors.password && (
                  <p className="text-red-500">ያስገቡት የይለፍ ቃል ትክክል መሆኑን ያረጋግጡ</p>
                )}
              </div>
