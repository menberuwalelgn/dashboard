...
const SendLetter = (props) =>{
  ...
  const onSubmit = (data) => {
    ...
    data.letterType ="official letter";
        ...
        />  
            ...
            <div class="ml-4 w-72">
                        ...
                        {getFile ? (
                          ...
                          <>
                            <div className="flex flex-col items-center justify-center pt-1">
                              ...
                              <p className="pt-1 text-lg font-serif tracking-wider text-yellow-600 group-hover:text-gray-600">
                                ይምረጡ
                              </p>
                            </div>
                            <input
                    ...
                    <div className="mt-5 ml-10">
                        <button type="submit" className="bg-red-400 hover:bg-hoverButton text-white py-3 px-6 rounded">
                           ይላኩ
                        </button>
                    </div>
              </form>
